    ...
    useEffect(() => {
        const handleListStudent = async () => {
            ...
            let res = await axios.get(
                apiUrl + `api/RegisterRoom/${selectedRoomId}/room`
            )
            setStudent(res.data)
        ...
        <>
            ...
            <div className='section row black'>
                <div>
                    ...
                    <div className='d-flex functions-container'>
                        <FormControl className='form-control'>
                            ...
                            <Select
                                ...
                                onChange={(event) =>
                                    handleSearchListRoom(event.target.value)
                                }
                            >
                    ...
                    >
                        ...
                        <div className='room-status-item col text-primary d-flex align-items-center justify-content-center'>
                            <i
                                className='fa fa-home fa-xl mr-2'
                                aria-hidden='true'
                            ></i>
                            Phòng còn trống
                        </div>
                            ...
                            state.ListRooms.map((item, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                className='fa fa-home fa-2x mr-2'
                                                aria-hidden='true'
                                            ></i>
                                            {item.name}
                                        </div>
                ...
                <div className='row'>
                    ...
                    <table
                        className='table table-hover mt-2 shadow'
                        style={{ width: "67%" }}
                    >
                    ...
                    <table
                        className='table table-hover shadow mt-2'
                        style={{ width: "30%" }}
                    >
                        <thead className='bg-info text-white'>
                            <tr>
